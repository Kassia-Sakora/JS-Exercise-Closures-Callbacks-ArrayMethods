 ...
 * should return 1000.
*/
function processSum(numberList, call) {
  return call(numberList.reduce((acc, cv) => acc + cv,0));
}
 ...
 * should return 1000.
*/
function processProduct(num1, num2, cback) {
  return cback(num1*num2)
}
 ...
 * should return "sad".
*/
function processContains(item, list, back) {
 return back(list.includes(item))
}
...
function getRunnersByTShirtSize(runners, tShirtSize) {
  return runners.filter((s) => s.shirt_size === tShirtSize);
}
